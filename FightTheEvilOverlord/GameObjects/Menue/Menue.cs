...
namespace FightTheEvilOverlord
{
    class Menue 
    {
        ...
        public Menue()
        {
            ...
            this.play = new Button(Utility.CurrentContent.Load<Texture2D>("MenuGraphics\\button_menu_start"), GameState.GameStart,"play");
            this.play.GetComponent<Transform>().Position = new Vector2(700, 400);
            ...
            this.option = new Button(Utility.CurrentContent.Load<Texture2D>("MenuGraphics\\button_menu_option"), GameState.Options,"option");
            this.option.GetComponent<Transform>().Position = new Vector2(700, 500);
            ...
            this.credits = new Button(Utility.CurrentContent.Load<Texture2D>("MenuGraphics\\button_menu_credits"), GameState.Credits,"Credits");
            this.credits.GetComponent<Transform>().Position = new Vector2(700, 600);
            ...
            this.exit = new Button(Utility.CurrentContent.Load<Texture2D>("MenuGraphics\\button_menu_exit"), GameState.Exit,"exit");
            this.exit.GetComponent<Transform>().Position = new Vector2(700, 700);
